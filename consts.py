...
PREPREDICTION_LENGTH = 15 #How much time we want to make a prediction
...
WINDOW_SIZE = 35 # Jump size of negative segments
POSTIVE_EXTRACT_INTERVAL = 55 # the time interval between labels.starttime and labels.stoptime we extract postive segments
